...
/**
 * @OA\Schema(
 *      title="Payment Method Update Form Request Fields",
 *      description="Payment Method Update request body data",
 *      type="object",
 *      required={"name"}
 * )
 */

class PaymentMethodUpdateFormRequest extends FormRequest
{
    /**
     * @OA\Property(
     *      title="name",
