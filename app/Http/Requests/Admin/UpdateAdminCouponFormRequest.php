...
/**
 * @OA\Schema(
 *      title="Admin Update Coupon Form Request Fields",
 *      description="Admin Update Coupon Update request body data",
 *      type="object",
 *      required={"name"}
 * )
 */

class UpdateAdminCouponFormRequest extends FormRequest
{
